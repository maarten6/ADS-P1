...
"""Output checker for OfflineCPSAT.py, the program by the Federal Vaccination Agency to schedule vaccinations. Will check if the output is consistent with the input"""
import OfflineCPSAT as offline
import sys
import os
